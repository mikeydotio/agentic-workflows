...
`.pilot/handoffs/handoff-<step>.md` where `<step>` is the step name (e.g., `interrogate`, `research`, `design`).
...
2. Use `AskUserQuestion`:
   ...
   - **question:** "The handoff document from the previous step is missing (`.pilot/handoffs/handoff-<step>.md`). Without it, I'll be working with limited context about decisions and rationale from the prior step. The artifacts themselves are intact."
   - **options:**
...
|----------------|-------------------|
| Interrogate | All of `.pilot/` |
| Research | `.pilot/research/`, `.pilot/TEAM.md`, `.pilot/handoffs/handoff-interrogate.md` |
| Design | `.pilot/DESIGN.md`, `.pilot/handoffs/handoff-research.md` |
| Plan | `.pilot/PLAN.md`, `.pilot/handoffs/handoff-design.md` |
| Decompose | `.pilot/plan-mapping.json`, `.pilot/handoffs/handoff-plan.md` |
| Execute | Stories (via storyhook), `.pilot/handoffs/handoff-decompose.md` |
| Review+Validate | `.pilot/REVIEW-REPORT.md`, `.pilot/VALIDATE-REPORT.md`, `.pilot/handoffs/handoff-execute.md` |
| Triage | `.pilot/TRIAGE.md`, `.pilot/handoffs/handoff-review.md`, `.pilot/handoffs/handoff-validate.md` |
| Document | `.pilot/DOCUMENTATION.md`, `.pilot/handoffs/handoff-triage.md` |
| Deploy | `.pilot/DEPLOY-APPROVAL.md`, `.pilot/COMPLETION.md`, `.pilot/handoffs/handoff-document.md` |

After deleting, re-invoke `/pilot continue` — the state detection picks up from the correct step.
